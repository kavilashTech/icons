              ...
              <div class="form-group required">
                <div class="col-xs-6">
                  <div class="form-inline">
                    ...
                    <input type="text" class="form-control" id="txtmembershipid" name="txtmembershipid" placeholder="Enter Membership Id" minlength="4" maxlength="150" required style="width:98%" value="<?php echo $memberId; ?>">
