...
// alert(confFlag + ' ' + preconfFlag1 + ' ' + preconfFlag2);
			...
			if(preConfDiscount == 'Y') {
				// alert(preConfDiscount);
				document.getElementById("discountBlock").style.visibility = "visible";
				// document.getElementById("preConfDiscount").style.visibility = "visible";
				document.getElementById("preConfDiscount").innerHTML = preConf2;
				// document.getElementById("DiscountTotal").style.visibility = "visible";
				document.getElementById("DiscountTotal").innerHTML = GTotalFees - preConf2;
				GTotalFees = GTotalFees - preConf2;
			} else {
				document.getElementById("discountBlock").style.visibility = "hidden";
			}
...
<div class="container" id="main">
	<div class="container-fluid pt-2">
		...
		<form action="">
			...
			<div class="col-xs-4 mx-auto block-info2" style="min-height:200px;">
				...
				<div class="row" id="discountBlock" style="margin-bottom:auto;margin-top:3px;visibility:hidden">
					<hr id="hrTotal" >
					<div class="col-md-8" id="preConfDiscountText" style="font-weight:500;color:red;">(Less) Pre-conf-2 Fees</div>
					<div class="col-md-2" id="preConfDiscount" style="font-weight:500;color:red;font-size:16px;text-align:right;">2000</div>
					<div class="col-md-8" id="DiscountTotalText" style="font-weight:bold;">Total after Discount</div>
					<div class="col-md-2" id="DiscountTotal" style="font-weight:bold;font-size:16px;text-align:right;">11000</div>
				</div>
	...
	if($nationality == 82){
	?>
	<p id="noteForDiscount" style="margin-left:40px;margin-top:25px;margin-right:40px;border:1px solid black;text-align:center;background-color:beige;"><span style="font-weight:bold;">Note : If you register for the Conference and also for one of the Pre-Conference workshops, the second Pre-confernece workshop will not be charged.</span></p>
<?php } ?>
	<div class="mar-top30">&nbsp;</div>
	<div class="mar-top30">&nbsp;</div>
	<div class="mar-top30">&nbsp;</div>
